...
internal static partial class WindowsDesktopInstrumentation
{
    ...
    private static void AttachWpf(GuanceClient client)
    {
    ...
    private static void AttachOpenWpfWindows(GuanceClient client, WpfApplication app)
    {
    ...
    private static void AttachWpfWindow(GuanceClient client, Window window)
    {
    ...
    private static void AttachWinForms(GuanceClient client)
    {
    ...
    private static void AttachForm(GuanceClient client, WinForms.Form form)
    {
    ...
    private static void AttachControls(GuanceClient client, WinForms.Control.ControlCollection controls)
    {
    ...
    private static void AttachControl(GuanceClient client, WinForms.Control control)
    {
    ...
    private static void AttachToolStrip(GuanceClient client, WinForms.ToolStrip toolStrip)
    {
        AttachToolStripItems(client, toolStrip.Items);
    }

    private static void AttachToolStripItems(GuanceClient client, WinForms.ToolStripItemCollection items)
    {
    ...
    private static void AttachToolStripItem(GuanceClient client, WinForms.ToolStripItem item)
    {
    ...
    private static void TrackWinFormsControlClick(GuanceClient client, WinForms.Control control)
    {
    ...
    private static void TrackWinFormsInput(GuanceClient client, WinForms.Control control)
    {
    ...
    private static void TrackWinFormsAction(GuanceClient client, string name, string replayInteractionType)
    {
        if (!TryGetActiveClient(out client))
        {
            return;
    ...
    private static void TrackWinFormsShortcut(GuanceClient client, WinForms.Control control, WinForms.KeyEventArgs args)
    {
        if (!TryGetActiveClient(out client))
        {
            return;
    ...
    private static void TrackWinFormsKeyDown(GuanceClient client, WinForms.Control control, WinForms.KeyEventArgs args)
    {
