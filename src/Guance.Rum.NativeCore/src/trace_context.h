...
struct TraceConfig {
    ...
    guance_rum_trace_type trace_type = GUANCE_RUM_TRACE_DDTRACE;
    std::string service_name;
    guance_rum_trace_should_trace_callback should_trace = nullptr;
    guance_rum_trace_context_provider_callback context_provider = nullptr;
