...
int main() {
    ...
    config.trace_type = GUANCE_RUM_TRACE_ZIPKIN_MULTI_HEADER;
    ...
    guance_rum_trace_config c_config{};
    c_config.struct_size = sizeof(c_config);
    c_config.version = GUANCE_RUM_TRACE_CONFIG_VERSION;
    c_config.trace_type = GUANCE_RUM_TRACE_DDTRACE;
